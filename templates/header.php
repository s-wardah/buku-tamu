...
// cek bila tidak ada user yang sudah login maka akan redirect ke halaman login
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <!-- <i class="fas fa-laugh-wink"></i> --> <i class="fas fa-school"></i>
                </div>
            ...
            <?php
            // cek apabila ada user login maka tampilkan logut
            if (isset($_SESSION['login'])):
            ?>
                <li class="nav-item">
            ...
            <?php
            // cek apabila ada user login maka tampilkan menu tambah buku
